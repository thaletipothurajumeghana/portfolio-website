const socials = [
    {
        platform: 'LinkedIn',
        handle: '@meghana-tp',
        url: 'http://www.linkedin.com/in/meghana-tp',
        color: '#0A66C2',
        icon: (
    ...
    {
        platform: 'GitHub',
        handle: '@thaletipothurajumeghana',
        url: 'https://github.com/thaletipothurajumeghana',
        color: '#24292E',
        icon: (
            <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
    ...
    },
    {
        platform: 'Kaggle',
        handle: '@meghanasai',
        url: 'https://www.kaggle.com/meghanasai',
        color: '#20BEFF',
        icon: (
            <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
                <path d="M18.825 23.859c-.022.092-.117.141-.281.141h-3.139c-.187 0-.351-.082-.492-.248l-5.178-6.589-1.448 1.374v5.111c0 .235-.117.352-.351.352H5.505c-.236 0-.354-.117-.354-.352V.353c0-.233.118-.353.354-.353h2.431c.234 0 .351.12.351.353v14.343l6.203-6.272c.165-.165.33-.246.495-.246h3.239c.144 0 .236.06.281.18.046.149.034.238-.036.27l-6.555 6.344 6.836 8.507c.095.118.116.211.075.281z" />
            </svg>
        ),
    },
    {
        platform: 'Instagram',
        handle: '@__meghana__6',
        url: 'https://www.instagram.com/__meghana__6/',
        color: '#E1306C',
        icon: (
            <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
    ...
    {
        platform: 'Email',
        handle: 'thaletipothurajumeghana@gmail.com',
        url: 'mailto:thaletipothurajumeghana@gmail.com',
        color: '#EA4335',
        icon: (
        ...
        <section id="contact">
            ...
            <div className="contact-grid">
                ...
                <div className="glass contact-form">
                    ...
                    <form action="https://formsubmit.co/thaletipothurajumeghana@gmail.com" method="POST">
                        ...
                        <div className="form-group">
                            ...
                            <textarea name="message" required className="form-textarea" placeholder="What's on your mind?" />
                        </div>
                        <button type="submit" className="form-submit">Say Hi!</button>
                    </form>
                </div>
                            ...
                            >
                                <div className="social-card-left">
                                    ...
                                    <div className="social-card-info">
                                        <div className="social-card-name">{s.platform}</div>
